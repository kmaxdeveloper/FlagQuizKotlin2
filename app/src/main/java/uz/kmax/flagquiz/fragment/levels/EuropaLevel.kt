...
class EuropaLevel: BaseFragment<UniversalFragmentBinding>(UniversalFragmentBinding::inflate) {
    ...
    override fun onViewCreate() {
        dialog.europaDialog()
        binding.textLevels.setText(R.string.level_europa)
        ...
        binding.imgLeft.setOnTouchListener { _, event ->
            if (event.action == MotionEvent.ACTION_DOWN) {
                ...
                if (array.EuropaTrueAndFalse[numLeft] > array.EuropaTrueAndFalse[numRight]) {
    ...
    private fun levelProgress(){
        ...
        binding.imgLeft.setImageResource(array.Europa[numLeft])
        binding.textLeft.setText(array.EuropaName[numLeft])
        binding.imgRight.setImageResource(array.Europa[numRight])
        binding.textRight.setText(array.EuropaName[numRight])
    }
